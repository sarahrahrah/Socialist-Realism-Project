...
count_train = tfidfvectorizer.fit_transform(X_train.values)
count_test = tfidfvectorizer.transform(X_test.values)
...
print_top10(tfidfvectorizer, runb_classifier, runb_classifier.classes_)
